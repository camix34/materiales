...
public class MaterialController {
    ...
    public ResponseEntity<Map<String, String>> subirImagen(@RequestParam("archivo") MultipartFile archivo) {
        ...
        try {
            // Carpeta donde guardarás la imagen (ajústala si lo deseas fuera del classpath)
            ...
            e.printStackTrace();
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body(Map.of("error", "Error al guardar: " + e.getMessage()));
        }
    }
